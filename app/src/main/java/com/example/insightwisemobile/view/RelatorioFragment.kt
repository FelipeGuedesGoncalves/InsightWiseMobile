...
// FRAGMENTO DE RELATORIO -  Posteriormente apresentarão as informações que o
...
class RelatorioFragment : Fragment() {
    override fun onCreateView(
        ...
        val dashboardTextView = view.findViewById<TextView>(R.id.relatorio_text)
        dashboardTextView.text = "Relatorio"
